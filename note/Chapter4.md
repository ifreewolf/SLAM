...
- [李群与李代数](#李群与李代数)
- [4.1 李群与李代数基础](#41-李群与李代数基础)
  - [4.1.1 群](#411-群)
  - [4.1.2 李代数的引出](#412-李代数的引出)
  - [4.1.3 李代数的定义](#413-李代数的定义)
  - [4.1.4 李代数$\\mathfrak{so}(3)$](#414-李代数mathfrakso3)
  - [4.1.5 李代数$\\mathfrak{se}(3)$](#415-李代数mathfrakse3)
- [4.2 指数于对数映射](#42-指数于对数映射)
  - [4.2.1 SO(3)上的指数映射](#421-so3上的指数映射)
  - [4.2.2 SE(3)上的指数映射](#422-se3上的指数映射)
- [4.3 李代数求导与扰动模型](#43-李代数求导与扰动模型)
  - [4.3.1 BCH公式与近似形式](#431-bch公式与近似形式)
  - [4.3.2 SO(3)上的李代数求导](#432-so3上的李代数求导)
  - [4.3.3 李代数求导](#433-李代数求导)
  - [4.3.4 扰动模型(左乘)](#434-扰动模型左乘)
  - [4.3.5 SE(3)上的李代数求导](#435-se3上的李代数求导)
