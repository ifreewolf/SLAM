...
- [非线性优化](#非线性优化)
- [6.1 状态估计问题](#61-状态估计问题)
  - [6.1.1 批量状态估计与最大后验估计](#611-批量状态估计与最大后验估计)
  - [6.1.2 最小二乘的引出](#612-最小二乘的引出)
  - [6.1.3 例子：批量状态估计](#613-例子批量状态估计)
- [6.2 非线性最小二乘](#62-非线性最小二乘)
  - [6.2.1 一阶和二阶梯度法](#621-一阶和二阶梯度法)
    - [6.2.2 高斯牛顿法](#622-高斯牛顿法)
- [](#)
